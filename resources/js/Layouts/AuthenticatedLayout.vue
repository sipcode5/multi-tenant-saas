...
const page = usePage();
const currentOrg = computed(() => page.props.currentOrganization);
</script>
        ...
        <div class="min-h-screen bg-gray-100">
                    ...
                    <div class="flex h-16 justify-between">
                        <div class="flex">
                            ...
                            >
                                ...
                                <NavLink
                                    v-if="currentOrg"
                                    :href="route('organizations.members.index', currentOrg.slug)"
            ...
            >
                ...
                <div
                    ...
                    class="rounded-md bg-red-50 p-4 text-sm text-red-800 border border-red-200"
                >
